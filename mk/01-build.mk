...
build: deps-check ## Build unified CLI (primary component)
...
build-all-platforms: deps-check ## Build unified CLI for all platforms (optional)
...
build-dev: deps-check ## Build unified CLI for development with race detection
